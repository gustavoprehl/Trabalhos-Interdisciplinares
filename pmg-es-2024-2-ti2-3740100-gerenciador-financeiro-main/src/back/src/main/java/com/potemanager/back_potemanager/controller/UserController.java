...
public class UserController {
    ...
    @PostMapping("/lerNotificacoes")
    public ResponseEntity<Void> lerNotificacoes(@Valid @RequestBody UserLerNotificacoesDTO obj){
        this.userService.lerNotificacoes(obj);
        return ResponseEntity.noContent().build();
    }
